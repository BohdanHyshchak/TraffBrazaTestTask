package com.example.traffbraza.game.utils

object GameUtils {

    const val PLAYER_X = "X" // player 1
    const val PLAYER_O = "O" // player 2
    ...
    fun gameResult(board: ArrayList<String>): String {
        when {
            isGameWon(board, PLAYER_X) -> return "PLAYER X Won"
            isGameWon(board, PLAYER_O) -> return "PLAYER 0 Won"
